...
(b) Determine the class of the first three columns using `spec()` or `typeof()`. Write your answer in a comment.
...
13\. How many cars were from before 2004? What percent/proportion do these represent?
